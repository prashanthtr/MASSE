...
class Sound {
    ...
    play(volume, dur, delay) {
        ...
        //no decay - epxec t to hear overlapping sounds

        //gain.gain.setTargetAtTime(0, ct+(dur-100)/1000, 0.03);
...
export function synth_context (acontext){
...
export function sel_rand_sound (){

    return sounds[Math.floor(Math.random()*sounds.length)];

}

export function indexed_sound (ind){
